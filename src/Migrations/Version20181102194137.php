 ...
 */
final class Version20181102194137 extends AbstractMigration
{
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE clasificacion_ticket (id INT AUTO_INCREMENT NOT NULL, estado_cla_id INT DEFAULT NULL, user_id INT DEFAULT NULL, codigo INT NOT NULL, descripcion VARCHAR(255) DEFAULT NULL, nombre VARCHAR(255) DEFAULT NULL, INDEX IDX_CCB105B02A43A2E9 (estado_cla_id), INDEX IDX_CCB105B0A76ED395 (user_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE estado_clasificacion_ticket (id INT AUTO_INCREMENT NOT NULL, id_estado_cla INT NOT NULL, descripcion VARCHAR(255) DEFAULT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE estado_intervencion (id INT AUTO_INCREMENT NOT NULL, id_estado INT NOT NULL, descripcion VARCHAR(255) DEFAULT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
        $this->addSql('CREATE TABLE estado_ticket (id INT AUTO_INCREMENT NOT NULL, id_estado INT NOT NULL, descripcion VARCHAR(255) DEFAULT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE intervencion (id INT AUTO_INCREMENT NOT NULL, grupo_resolucion_id INT DEFAULT NULL, ticket_id INT DEFAULT NULL, codigo INT DEFAULT NULL, observaciones VARCHAR(255) DEFAULT NULL, INDEX IDX_1CD67B8DA0FF6FD8 (grupo_resolucion_id), INDEX IDX_1CD67B8D700047D2 (ticket_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
        $this->addSql('CREATE TABLE item_historico_clasificacion (id INT AUTO_INCREMENT NOT NULL, clasificacion_id INT DEFAULT NULL, user_id INT DEFAULT NULL, ticket_id INT DEFAULT NULL, id_item INT NOT NULL, fecha_desde DATETIME DEFAULT NULL, fecha_hasta DATETIME DEFAULT NULL, hora_desde TIME DEFAULT NULL, hora_hasta TIME DEFAULT NULL, observacion VARCHAR(255) DEFAULT NULL, INDEX IDX_EDA484DA78ECAC4A (clasificacion_id), INDEX IDX_EDA484DAA76ED395 (user_id), INDEX IDX_EDA484DA700047D2 (ticket_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
        $this->addSql('CREATE TABLE item_historico_estados (id INT AUTO_INCREMENT NOT NULL, estado_ticket_id INT DEFAULT NULL, user_id INT DEFAULT NULL, ticket_id INT DEFAULT NULL, id_item INT NOT NULL, fecha_desde DATETIME DEFAULT NULL, fecha_hasta DATETIME DEFAULT NULL, hora_desde TIME DEFAULT NULL, hora_hasta TIME DEFAULT NULL, observacion VARCHAR(255) DEFAULT NULL, INDEX IDX_91D2DF8EAE4A2FA4 (estado_ticket_id), INDEX IDX_91D2DF8EA76ED395 (user_id), INDEX IDX_91D2DF8E700047D2 (ticket_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
        $this->addSql('CREATE TABLE item_historico_intervencion (id INT AUTO_INCREMENT NOT NULL, estado_intervencion_id INT DEFAULT NULL, user_id INT DEFAULT NULL, id_item INT DEFAULT NULL, fecha_desde DATETIME DEFAULT NULL, fecha_hasta DATETIME DEFAULT NULL, hora_desde TIME DEFAULT NULL, hora_hasta TIME DEFAULT NULL, INDEX IDX_F0F5C50B2B50E810 (estado_intervencion_id), INDEX IDX_F0F5C50BA76ED395 (user_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
        $this->addSql('CREATE TABLE ticket (id INT AUTO_INCREMENT NOT NULL, empleado_id INT DEFAULT NULL, user_id INT DEFAULT NULL, nro_ticket INT NOT NULL, descripcion VARCHAR(255) NOT NULL, fecha DATETIME DEFAULT NULL, hora TIME DEFAULT NULL, INDEX IDX_97A0ADA3952BE730 (empleado_id), INDEX IDX_97A0ADA3A76ED395 (user_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
